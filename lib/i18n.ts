      ...
      items: [
        {
          ...
          bullets: [
            ...
            "Gained familiarity with **Kubernetes** in production through mentorship from senior developers on the team, understanding the deploy flow, autoscaling and absorption of incoming traffic in a high-availability environment.",
      ...
      items: [
        {
          ...
          bullets: [
            ...
            "Ganhei familiaridade com **Kubernetes** em produção através de mentoria com os desenvolvedores sênior da equipe, entendendo o fluxo de deploy, autoscaling e absorção de tráfego entrante em ambiente de alta disponibilidade.",
